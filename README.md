...
**aknowledgements**: [yingkitw/xls-rs](https://github.com/yingkitw/xls-rs)

#### Abstract

[yingkitw/xls-rs](https://github.com/yingkitw/xls-rs) is a Rust CLI for reading, writing, converting, and transforming spreadsheet-like files. This component provides a wrapper class for calling it via SystemWorker.
